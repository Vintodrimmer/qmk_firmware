 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Alt  | Prnt | Ctrl |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Escape| Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Alt  | Prnt | Ctrl |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_WORKMAN] = {
 ...
 */
[_LOWER] = {
  {KC_TILD, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______, KC_LPRN, KC_RPRN, _______, _______,  KC_BSPC},
  {_______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______, KC_LBRC, KC_RBRC, KC_UNDS, KC_PLUS,  KC_PIPE},
  {_______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_LCBR, KC_RCBR, KC_UP,   _______,  _______},
 ...
 */
[_RAISE] = {
  {KC_GRV,  KC_EXLM, KC_1,    KC_2, KC_3,    _______, _______, KC_DLR_, KC_AMPR, _______, _______, KC_BSPC},
  {_______, KC_AT,   KC_4,    KC_5, KC_6,    _______, _______, KC_PERC, KC_ASTR  KC_MINS, KC_EQL,  KC_BSLS},
  {_______, KC_HASH, KC_7,    KC_8, KC_9,    _______, _______, KC_CIRC, _______, KC_PGUP, _______, _______},
